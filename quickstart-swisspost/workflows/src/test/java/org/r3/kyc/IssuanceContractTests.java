...
public class IssuanceContractTests {

    private static final Logger logger = LoggerFactory.getLogger(IssuanceContractTests.class);
    ...
    public CCDState setupCCD(String method) {
        ...
        switch (method.toLowerCase()) {
            ...
            case "teststandardverifies":
                ...
                break;
            default:
                // valid state for onwards consumption
     ...
     */
    @Test
    public void dummyTestForTemplateStateIssue() {
